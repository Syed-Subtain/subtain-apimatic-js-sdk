...
export type RemovePaymentEventDataPaymentMethod =
  | PaymentMethodApplePayType
  | PaymentMethodBankAccountType
  | PaymentMethodCreditCardType
  | PaymentMethodExternalType
...
export namespace RemovePaymentEventDataPaymentMethod {
   ...
   */
  export function isPaymentMethodApplePayType(
    value: unknown
  ): value is PaymentMethodApplePayType {
   ...
   */
  export function isPaymentMethodBankAccountType(
    value: unknown
  ): value is PaymentMethodBankAccountType {
    const validationResult = validateAndMap(
      value,
      paymentMethodBankAccountTypeSchema
    );
   ...
   */
  export function isPaymentMethodCreditCardType(
    value: unknown
  ): value is PaymentMethodCreditCardType {
    const validationResult = validateAndMap(
      value,
      paymentMethodCreditCardTypeSchema
    );
   ...
   */
  export function isPaymentMethodExternalType(
    value: unknown
  ): value is PaymentMethodExternalType {
    const validationResult = validateAndMap(
      value,
      paymentMethodExternalTypeSchema
    );
   ...
   */
  export function isPaymentMethodPaypalType(
    value: unknown
  ): value is PaymentMethodPaypalType {
    const validationResult = validateAndMap(
      value,
      paymentMethodPaypalTypeSchema
    );
