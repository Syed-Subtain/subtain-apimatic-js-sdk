...
export type InvoiceEventEventData =
  | ApplyCreditNoteEventData
  | ApplyDebitNoteEventData
  | ApplyPaymentEventData
  | ChangeInvoiceCollectionMethodEventData
...
export namespace InvoiceEventEventData {
   ...
   */
  export function isApplyCreditNoteEventData(
    value: unknown
  ): value is ApplyCreditNoteEventData {
   ...
   */
  export function isApplyDebitNoteEventData(
    value: unknown
  ): value is ApplyDebitNoteEventData {
    const validationResult = validateAndMap(
      value,
      applyDebitNoteEventDataSchema
    );
   ...
   */
  export function isApplyPaymentEventData(
    value: unknown
  ): value is ApplyPaymentEventData {
   ...
   */
  export function isChangeInvoiceCollectionMethodEventData(
    value: unknown
  ): value is ChangeInvoiceCollectionMethodEventData {
    const validationResult = validateAndMap(
      value,
      changeInvoiceCollectionMethodEventDataSchema
    );
   ...
   */
  export function isIssueInvoiceEventData(
    value: unknown
  ): value is IssueInvoiceEventData {
   ...
   */
  export function isRefundInvoiceEventData(
    value: unknown
  ): value is RefundInvoiceEventData {
    const validationResult = validateAndMap(
      value,
      refundInvoiceEventDataSchema
    );
   ...
   */
  export function isRemovePaymentEventData(
    value: unknown
  ): value is RemovePaymentEventData {
    const validationResult = validateAndMap(
      value,
      removePaymentEventDataSchema
    );
   ...
   */
  export function isVoidInvoiceEventData(
    value: unknown
  ): value is VoidInvoiceEventData {
   ...
   */
  export function isVoidInvoiceEventData1(
    value: unknown
  ): value is VoidInvoiceEventData1 {
