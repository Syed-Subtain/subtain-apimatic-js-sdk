...
```ts
async allocateComponents(  subscriptionId: string,
...
```ts
async updatePrepaidUsageAllocation(  subscriptionId: string,
  componentId: number,
  allocationId: number,
...
```ts
async deletePrepaidUsageAllocation(  subscriptionId: string,
  componentId: number,
  allocationId: number,
...
```ts
async readSubscriptionComponent(  subscriptionId: string,
  componentId: number,
...
```ts
async listSubscriptionComponents(  subscriptionId: string,
...
```ts
async resetSubscriptionComponentsPricePoints(  subscriptionId: string,
...
```ts
async listAllocations(  subscriptionId: string,
  componentId: number,
  page?: number,
requestOptions?: RequestOptions): Promise<ApiResponse<AllocationResponse[]>>
```
...
```ts
async listUsages(  subscriptionId: string,
  componentId: number,
  sinceId?: number,
  maxId?: number,
  sinceDate?: string,
...
```ts
async allocateComponent(  subscriptionId: string,
  componentId: number,
...
```ts
async previewAllocations(  subscriptionId: string,
...
```ts
async updateSubscriptionComponentsPricePoints(  subscriptionId: string,
...
```ts
async recordEvents(  subdomain: string,
  apiHandle: string,
  storeUid?: string,
  body?: EBBEvent[],
requestOptions?: RequestOptions): Promise<ApiResponse<void>>
