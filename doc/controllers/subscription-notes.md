...
```ts
async updateSubscriptionNote(  subscriptionId: string,
  noteId: string,
...
```ts
async deleteSubscriptionNote(  subscriptionId: string,
...
```ts
async listSubscriptionNotes(  subscriptionId: string,
  page?: number,
  perPage?: number,
requestOptions?: RequestOptions): Promise<ApiResponse<SubscriptionNoteResponse[]>>
```
...
```ts
async readSubscriptionNote(  subscriptionId: string,
  noteId: string,
requestOptions?: RequestOptions): Promise<ApiResponse<SubscriptionNoteResponse>>
```
...
```ts
async createSubscriptionNote(  subscriptionId: string,
  body?: UpdateSubscriptionNoteRequest,
requestOptions?: RequestOptions): Promise<ApiResponse<SubscriptionNoteResponse>>
```
